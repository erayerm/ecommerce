...
export default function Footer() {
    return (
        <div className="w-screen text-main h-[414px]">
            ...
            <div className='w-full flex justify-center items-center h-[75px] text-sm text-gray leading-6 font-bold bg-light-gray-1'>Made With Love By Figmaland All Right Reserved</div>
        </div>
    )
}