...
export default function Contact() {
    ...
    return (
        <>
            <section className="w-screen">
                <div className="max-w-[1050px] mx-auto flex justify-between items-center">
                    <div className="flex flex-col gap-[35px] max-w-[400px]">
                        ...
                        <h1 className="font-bold text-[58px] leading-[80px] text-main">Get in touch
                            today!</h1>
                        <p className="text-gray text-xl leading-[30px] max-w-[376px]">We know how large objects will act, but things on a small scale</p>
                        <div className="text-main font-bold text-2xl leading-8 flex flex-col gap-[20px]">
            ...
            <section className='w-screen'>
                <div className='max-w-[1050px] mx-auto flex flex-col items-center font-bold text-main py-20 relative gap-4'>
                    ...
                    <div>
                        <button className='text-[#FFFFFF] text-sm leading-[22px] bg-blue rounded px-10 py-4'>Try it free now</button>
                    </div>
                </div>
