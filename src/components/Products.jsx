            ...
            <div className="my-0 mx-auto max-w-[1050px]">
                <div className="flex justify-between items-center py-6">
                    ...
                    <div className="flex gap-3.5">
                        <select name="vals" id="vals" className="pl-3 border-[1px] w-[150px] text-gray bg-[#DDDDDD] rounded">
                            <option value="val1">Popularity</option>
                            <option value="val2">Val2</option>
                            <option value="val3">Val3</option>
                            <option value="val4">Val4</option>
                        </select>
                        <button className="px-5 py-2.5 text-white bg-blue rounded">Filter</button>
                    </div>
                </div>
